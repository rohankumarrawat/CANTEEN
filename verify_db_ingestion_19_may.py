...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 19 MAY 2026 ===")
    ...
    expected_dry_issue = 13594.70
    expected_dry_bcf = 93256.50
    ...
    expected_pkg_issue = 9584.75
    expected_pkg_bcf = 44882.75
    ...
    expected_fresh_issue = 2819.62
    expected_fresh_bcf = 3951.40
    ...
    expected_rev = 49190.00
    expected_cogs = 35053.00
    expected_profit = 14137.00
    expected_prep = 1187
    expected_sold = 1174
    ...
    print("\n=== VERIFICATION SUMMARY FOR 19 MAY 2026 ===")
    if errors:
