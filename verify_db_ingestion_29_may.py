...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 29 MAY 2026 ===")
    ...
    expected_dry_issue = 13317.89
    expected_dry_bcf = 260915.77
    ...
    expected_pkg_issue = 9665.19
    expected_pkg_bcf = 42832.71  # Register total is 42832.17 due to rounding and clerk math discrepancy
    ...
    expected_fresh_issue = 7022.00
    expected_fresh_bcf = 1005.76
    ...
    expected_rev = 46300.00
    expected_cogs = 37743.00
    expected_profit = 8557.00
    expected_prep = 1139
    expected_sold = 1095
    ...
    print("\n=== VERIFICATION SUMMARY FOR 29 MAY 2026 ===")
    if errors:
