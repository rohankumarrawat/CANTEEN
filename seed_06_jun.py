...
dry_items = [
    ...
    ('Badi Elaichi', 'Kgs', 0.100, 0.000, 0.000, 1995.00, 0.000, 0.100, 199.50),
    ...
    ('Dhaniya (s)', 'Kgs', 1.250, 0.000, 0.050, 199.50, 9.975, 1.200, 239.40),
    ...
    ('Dhaniya Powder', 'Kgs', 4.900, 0.000, 0.100, 199.50, 19.950, 4.800, 957.60),
    ('Imli', 'Pkt', 0.000, 0.000, 0.000, 45.00, 0.000, 0.000, 0.00),
    ('Imli (expensive)', 'Pkt', 2.300, 0.000, 0.100, 120.00, 12.000, 2.200, 264.00),
    ...
    ('Haldi Powder', 'Kgs', 6.300, 0.000, 0.100, 231.00, 23.100, 6.200, 1432.20),
    ...
    ('Mirchi Powder', 'Kgs', 4.800, 0.000, 0.100, 315.00, 31.500, 4.700, 1480.50),
...
packaging_items = [
    ...
    ("Napkin Tissue Paper", "Nos", 8586, 0, 142, 0.354, 50.27, 8444, 2989.18),
    ...
    ("Big Foil Box (Biryani)", "Nos", 77, 0, 18, 3.360, 60.48, 59, 198.24),
...
fresh_items = [
    ...
    ("Coriander", "Kgs", 0.000, 0.300, 0.300, 166.65, 49.995, 0.000, 0.00),
