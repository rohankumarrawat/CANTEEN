...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 06 JUN 2026 ===")
    ...
    # Expected values:
    # Dry Issue Total: 3971.129 (Register written total: 3971.15, minor difference due to clerk rounding on R/OIL and LPG)
    # Dry BCF Total: 195870.805 (Register written total: 194821.61, difference due to persistent database stock of AMCHUR PDR 10.0kg@105 = 1050 and minor R/OIL CP rounding of 0.80)
    expected_dry_issue = 3971.129
    expected_dry_bcf = 195870.805
    ...
    # Expected values:
    # Packaging Issue Total: 2085.040 (Register written total: 2085.04)
    # Packaging BCF Total: 38358.097 (Register written total: 38357.76, difference of 0.337 due to Pickle & Paratha rounding)
    expected_pkg_issue = 2085.040
    expected_pkg_bcf = 38358.097
    ...
    expected_fresh_issue = 1371.995
    expected_fresh_bcf = 4198.400
    ...
    expected_rev = 10600.00
    expected_cogs = 8269.00
    expected_profit = 2331.00
    expected_prep = 709
    expected_sold = 156
    ...
    print("\n=== VERIFICATION SUMMARY FOR 06 JUN 2026 ===")
    if errors:
