...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 27 MAY 2026 ===")
    ...
    # DB Dry issue sum is 12062.31. The register written bottom total of 12332.35 has a minor discrepancy.
    # DB Dry BCF sum is 276131.94.
    expected_dry_issue = 12062.31
    expected_dry_bcf = 276131.94
    ...
    # Register issue total: 7530.17. DB calculated: 7530.25.
    # Register BCF total: 52497.26. DB calculated: 52497.90.
    expected_pkg_issue = 7530.25
    expected_pkg_bcf = 52497.90
    ...
    expected_sw_issue = 2800.00
    expected_sw_bcf = 6170.00
    ...
    expected_fresh_issue = 5471.73
    expected_fresh_bcf = 2932.76
    ...
    expected_rev = 38135.00
    expected_cogs = 32132.00
    expected_profit = 6003.00
    expected_prep = 986
    expected_sold = 965
    ...
    print("\n=== VERIFICATION SUMMARY FOR 27 MAY 2026 ===")
    if errors:
