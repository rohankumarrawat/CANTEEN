...
dry_items = [
    ...
    ('Rajma', 'Kgs', 31.000, 80.000, 0.000, 115.00, 0.000, 111.000, 12765.00),
    ...
    ('Urad Dal Chilka', 'KGS', 3.000, 15.000, 3.000, 110.00, 330.000, 15.000, 1650.00),
    ('Masoor Dal (Malika)', 'Kgs', 3.000, 15.000, 3.000, 85.00, 255.000, 15.000, 1275.00),
    ('Moong Dal Chilka', 'Kgs', 12.000, 15.000, 12.000, 110.00, 1320.000, 15.000, 1650.00),
    ...
    ('Haldi Powder', 'Kgs', 2.500, 7.000, 0.400, 231.00, 92.400, 9.100, 2102.10),
    ('Mirchi Powder', 'Kgs', 2.000, 6.000, 0.400, 315.00, 126.000, 7.600, 2394.00),
    ...
    ('Dhaniya (s)', 'Kgs', 0.160, 2.500, 0.200, 199.50, 39.901, 2.460, 490.78),
    ('Jeera Powder', 'Kgs', 0.000, 3.000, 0.000, 420.00, 0.000, 3.000, 1260.00),
    ('Chana Masala (pkt)', 'Pkt', 0.000, 0.000, 0.000, 736.01, 0.000, 0.000, 0.00),
    ('Badi Elaichi', 'Kgs', 0.000, 0.300, 0.020, 1995.00, 39.900, 0.280, 558.60),
    ...
    ('Rajma Masala (Kgs)', 'Kgs', 1.100, 1.600, 0.000, 736.00, 0.000, 2.700, 1987.88),
    ...
    ('Kewra Water', 'BTL', 5.000, 5.000, 0.000, 70.80, 0.000, 10.000, 708.00),
    ('Biryani Masala', 'Pkt', 4.000, 10.000, 0.000, 73.50, 0.000, 14.000, 1029.00),
    ('Elaichi Small Gr', 'Kgs', 0.000, 0.000, 0.000, 3150.00, 0.000, 0.000, 0.00),
    ('Dhaniya Powder', 'Kgs', 0.700, 7.000, 0.400, 199.50, 79.800, 7.300, 1456.35),
    ('Kali Mirch (s)', 'Kgs', 0.114, 0.400, 0.030, 882.00, 26.460, 0.484, 426.89),
    ('Moongphali Dana', 'Kgs', 0.000, 20.000, 0.000, 168.00, 0.000, 20.000, 3360.00),
    ...
    ('Baking Powder', 'PKT', 0.000, 4.000, 0.000, 67.20, 0.000, 4.000, 268.80),
    ('Shahi Paneer Masala (pkt)', 'PKT', 0.000, 0.000, 0.000, 86.50, 0.000, 0.000, 0.00),
    ('Shahi Paneer Masala (kgs)', 'kgs', 0.100, 1.600, 0.000, 880.00, 0.000, 1.700, 1496.00),
    ('Soya Bean Badiya', 'kgs', 10.000, 40.000, 0.000, 94.50, 0.000, 50.000, 4725.00),
    ('Javitri', 'Kgs', 0.250, 0.000, 0.050, 2730.00, 136.500, 0.200, 546.00),
    ('Amchur Powder', 'Pkt', 0.000, 10.000, 0.000, 105.00, 0.000, 10.000, 1050.00),
    ...
    ('Imli (expensive)', 'Pkt', 1.000, 3.000, 0.250, 120.00, 30.000, 3.750, 450.00),
...
packaging_items = [
    ...
    ("Napkin Tissue Paper", "Nos", 7813, 1800, 614, 0.354, 217.36, 8999, 3185.65),
    ...
    ("Big Foil Box (Biryani)", "Nos", 28, 300, 61, 3.150, 192.15, 267, 841.05),
...
fresh_items = [
    ...
    ("Coriander", "Kgs", 2.000, 0, 2.000, 30.000, 60.00, 0.000, 0.00),
...
sales_summary = [
    ...
    ("Lahori Zeera", 2, 2, 10.0, 20.0, 18.0),
