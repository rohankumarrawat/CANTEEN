...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 22 MAY 2026 ===")
    ...
    # DB sum is 13498.60 vs 13498.65 expected in register due to minor rounding differences in R/OIL (1809.20 calculated in DB vs 1809.231 in register).
    # DB BCF sum is 60808.91 vs 60809.21 expected in register due to rate rounding on R/OIL (-0.30 diff) and LPG (-0.04 diff).
    expected_dry_issue = 13498.60
    expected_dry_bcf = 60808.91
    ...
    # In the register: expected_pkg_issue = 10250.83. DB is 10250.93 (due to PICKLE & PARATHA issue rounding diff of 0.10).
    # In the register: BCF sum is 23139.70. DB is 23140.64 (due to PICKLE & PARATHA BCF rounding diff of 0.94).
    expected_pkg_issue = 10250.93
    expected_pkg_bcf = 23140.64
    ...
    expected_fresh_issue = 6356.10
    expected_fresh_bcf = 1684.53
    ...
    expected_rev = 47945.00
    expected_cogs = 38109.00
    expected_profit = 9836.00
    expected_prep = 1144
    expected_sold = 1130
    ...
    print("\n=== VERIFICATION SUMMARY FOR 22 MAY 2026 ===")
    if errors:
