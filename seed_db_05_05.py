...
inventory_data = [
    ...
    ("DANIYA (S)", "Dry", "Kgs", 157.50, 0.100),
    ("JEERA PDR", "Dry", "Kgs", 420.00, 0.200),
    ...
    ("CLEAN WRAP", "Dry", "Pkt", 450.00, 0.750),
    ...
    ("BAKING PDR", "Dry", "Pkt", 67.20, 1.000),
    ...
    # Packaging
    ("PP BOX (DAL) MINI MEAL", "Packaging", "Nos", 3.186, 501.0),
    ("FOIL BOX (RICE,SABJI)", "Packaging", "Nos", 1.575, 1002.0),
    ("ROTI POUCH", "Packaging", "Nos", 236.000, 2.800),
    ("SALAD PKT", "Packaging", "Nos", 0.177, 1002.0),
    ("SPOON/MINI MEAL", "Packaging", "Nos", 0.504, 562.0),
    ("NEPKIN TUSSU PEPAR", "Packaging", "Nos", 0.354, 574.0),
    ("SALT POUCH", "Packaging", "Nos", 0.150, 501.0),
    ("PICKLE & PARATHA", "Packaging", "Nos", 0.899, 574.0),
    ("TAPE", "Packaging", "Nos", 23.600, 2.0),
    ("BIG FOIL BOX (BIRIYANI)", "Packaging", "Nos", 3.150, 61.0),
    ("PAPER BOX (LUNCH)", "Packaging", "Nos", 4.956, 501.0),
    ("BUTTER ROTI PAPER", "Packaging", "Nos", 236.000, 0.0),
    ("PARATHA BOX", "Packaging", "Nos", 3.360, 73.0),
    ("PARTATION BOX", "Packaging", "Nos", 6.960, 0.0),
    ("BLACK PACKET", "Packaging", "Nos", 141.600, 2.0),
