...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 30 MAY 2026 ===")
    ...
    # Calculated issues and BCF from register and database
    expected_dry_issue = 5042.73
    expected_dry_bcf = 260304.90
    ...
    expected_pkg_issue = 2354.02
    expected_pkg_bcf = 40478.69  # Register total is 40478.18 due to clerk math rounding on Pickle & Paratha
    ...
    expected_sw_issue = 560.00
    expected_sw_bcf = 2250.00
    ...
    expected_fresh_issue = 1193.90
    expected_fresh_bcf = 10216.23
    ...
    expected_rev = 10950.00
    expected_cogs = 8629.00
    expected_profit = 2321.00
    expected_prep = 174
    expected_sold = 170
    ...
    print("\n=== VERIFICATION SUMMARY FOR 30 MAY 2026 ===")
    if errors:
