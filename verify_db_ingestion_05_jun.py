...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 05 JUN 2026 ===")
    ...
    # Expected values:
    # Dry Issue Total: 12903.267 (Register written total: 12903.33, minor difference due to clerk rounding on R/OIL and LPG)
    # Dry BCF Total: 199841.934 (Register written total: 198792.76, difference due to persistent database stock of AMCHUR PDR 10.0kg@105 = 1050 and minor R/OIL CP rounding of 0.80)
    expected_dry_issue = 12903.267
    expected_dry_bcf = 199841.934
    ...
    # Expected values:
    # Packaging Issue Total: 8957.960 (Register written total: 8957.86, difference of 0.10 due to Pickle & Paratha rounding)
    # Packaging BCF Total: 40443.137 (Register written total: 40442.80, difference of 0.337 due to Pickle & Paratha rounding)
    expected_pkg_issue = 8957.960
    expected_pkg_bcf = 40443.137
    ...
    expected_fresh_issue = 6040.00
    expected_fresh_bcf = 5170.40
    ...
    expected_rev = 46680.00
    expected_cogs = 35501.00
    expected_profit = 11179.00
    expected_prep = 1129
    expected_sold = 1094
    ...
    print("\n=== VERIFICATION SUMMARY FOR 05 JUN 2026 ===")
    if errors:
