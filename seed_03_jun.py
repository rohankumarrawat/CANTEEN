...
dry_items = [
    ...
    ('Dhaniya (s)', 'Kgs', 1.350, 0.000, 0.000, 199.50, 0.000, 1.350, 269.33),
    ...
    ('Dhaniya Powder', 'Kgs', 5.600, 0.000, 0.200, 199.50, 39.900, 5.400, 1077.30),
    ...
    ('Haldi Powder', 'Kgs', 7.200, 0.000, 0.200, 231.00, 46.200, 7.000, 1617.00),
    ...
    ('Mirchi Powder', 'Kgs', 5.700, 0.000, 0.200, 315.00, 63.000, 5.500, 1732.50),
    ('Moong Dal Chilka', 'Kgs', 12.000, 0.000, 0.000, 110.00, 0.000, 12.000, 1320.00),
    ('Moongphali Dana', 'Kgs', 13.000, 0.000, 4.000, 168.00, 672.000, 9.000, 1512.00),
    ...
    ('Rajma', 'Kgs', 96.000, 0.000, 16.000, 115.00, 1840.000, 80.000, 9200.00),
    ('Rajma Masala (Kgs)', 'Kgs', 1.900, 0.000, 0.400, 736.25, 294.500, 1.500, 1104.38),
    ...
    ('Shahi Paneer Masala (kgs)', 'kgs', 1.000, 0.000, 0.400, 880.00, 352.000, 0.600, 528.00),
...
packaging_items = [
    ...
    ("Napkin Tissue Paper", "Nos", 10249, 0, 478, 0.354, 169.21, 9771, 3458.93),
    ...
    ("Big Foil Box (Biryani)", "Nos", 260, 0, 61, 3.360, 204.96, 199, 668.64),
...
sales_summary = [
    ...
    ("Amul Kool", 8, 8, 25.0, 200.0, 176.0),
...
def seed_db():
    ...
    try:
        ...
        samples_list = [
            ("LUNCH",    5, "05 X LUNCH SAMPLE",      "General"),
