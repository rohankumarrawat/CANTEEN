...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 23 MAY 2026 ===")
    ...
    # DB Dry issue sum matches register's 3929.00 exactly (after rounding R/OIL and LPG issue rates).
    # DB Dry BCF sum matches register's 60482.21 exactly (after rounding R/OIL and LPG rate components).
    # DB sum is 3928.98 vs 3929.00 expected in register due to R/OIL rounding diff (995.06 calculated vs 995.077 register).
    # DB BCF sum is 60481.88 vs 60482.21 expected in register due to rate rounding on R/OIL (-0.25 diff) and LPG (-0.07 diff).
    expected_dry_issue = 3928.98
    expected_dry_bcf = 60481.88
    ...
    # In the register: expected_pkg_issue = 2325.34. DB is 2325.36 (due to PP BOX and Salad Pkt rounding diffs).
    # In the register: BCF sum is 20814.36. DB is 20815.28 (due to PICKLE & PARATHA BCF rounding diff of 0.92).
    expected_pkg_issue = 2325.36
    expected_pkg_bcf = 20815.28
    ...
    expected_sw_issue = 840.00
    expected_sw_bcf = 0.00
    ...
    # DB Fresh issue is 1255.13 vs 1255.14 expected due to rounding.
    expected_fresh_issue = 1255.13
    expected_fresh_bcf = 11954.16
    ...
    expected_rev = 10775.00
    expected_cogs = 8460.00
    expected_profit = 2315.00
    expected_prep = 165
    expected_sold = 162
    ...
    print("\n=== VERIFICATION SUMMARY FOR 23 MAY 2026 ===")
    if errors:
