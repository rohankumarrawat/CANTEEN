...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 20 MAY 2026 ===")
    ...
    expected_dry_issue = 13462.80
    expected_dry_bcf = 79793.69
    ...
    expected_pkg_issue = 7972.31
    expected_pkg_bcf = 36910.45
    ...
    expected_fresh_issue = 3055.25
    expected_fresh_bcf = 3770.26
    ...
    expected_rev = 40325.00
    expected_cogs = 31857.00
    expected_profit = 8468.00
    expected_prep = 1022
    expected_sold = 988
    ...
    print("\n=== VERIFICATION SUMMARY FOR 20 MAY 2026 ===")
    if errors:
