...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 25 MAY 2026 ===")
    ...
    # DB Dry issue sum is 11352.57 vs 11402.61 expected in register (difference of 50.00 and some rounding on LPG/Daniya/Degi).
    # DB Dry BCF sum is 300664.13. This includes SABUDANA (1050.00). Without Sabudana, it is 299614.13.
    # Register total was 299848.52 (with RICE at rate 68.00). The difference of ~234.39 is due to:
    # - RiceCP change (+3012.00)
    # - Dal Chana discrepancy (-180.00)
    # - Mirchi (S) discrepancy (-52.50)
    # - Rounding errors on LPG, R/Oil, Kitchen King, etc.
    expected_dry_issue = 11352.57
    expected_dry_bcf = 300664.13
    ...
    # Register issue total: 9134.95. DB calculated: 9135.05.
    # Register BCF total: 54175.01. DB calculated: 54175.83.
    expected_pkg_issue = 9135.05
    expected_pkg_bcf = 54175.83
    ...
    expected_fresh_issue = 4036.62
    expected_fresh_bcf = 8541.76
    ...
    expected_rev = 47830.00
    expected_cogs = 31212.00
    expected_profit = 16618.00
    expected_prep = 1137
    expected_sold = 1120
    ...
    print("\n=== VERIFICATION SUMMARY FOR 25 MAY 2026 ===")
    if errors:
