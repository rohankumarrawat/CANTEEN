...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 18 MAY 2026 ===")
    ...
    # In the register: expected_dry_issue = 12939.47 (using Paratha Masala rate = 10, issue = 8 -> cost = 80.00). DB sum is 12939.40.
    # In the register: BCF sum is 105095.74. DB sum is 105083.68 (due to LAUNG BCF discrepancy: 161.70 in register vs 150.15 in DB, diff = 11.55; and R/OIL, LPG floating point diffs).
    expected_dry_issue = 12939.40
    expected_dry_bcf = 105083.68
    ...
    # In the register: expected_pkg_issue = 9438.22. DB sum is 9438.32.
    # In the register: BCF sum is 54466.17. DB sum is 54467.50 (due to PICKLE & PARATHA discrepancy: 7165.77 in register vs 7167.10 in DB, diff = 1.33).
    expected_pkg_issue = 9438.32
    expected_pkg_bcf = 54467.50
    ...
    expected_fresh_issue = 3406.49
    expected_fresh_bcf = 5646.02
    ...
    expected_rev = 49050.00
    expected_cogs = 32962.00
    expected_profit = 16088.00
    expected_prep = 1179
    expected_sold = 1164
    ...
    print("\n=== VERIFICATION SUMMARY FOR 18 MAY 2026 ===")
    if errors:
