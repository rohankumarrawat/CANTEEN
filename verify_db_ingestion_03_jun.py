...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 03 JUN 2026 ===")
    ...
    # Expected values:
    # Dry Issue Total: 12480.947 (Printed register total is 12480.99, difference of 0.043 due to rounding)
    # Dry BCF Total: 226270.705 (Printed register total is 225221.65, difference due to persistent database stock of AMCHUR PDR (10.0 kg @ 105.00 = 1050.00) and minor roundings)
    expected_dry_issue = 12480.947
    expected_dry_bcf = 226270.705
    ...
    # Expected values:
    # Packaging Issue Total: 7249.455 (Printed register total: 7249.38)
    # Packaging BCF Total: 56622.507 (Printed register total: 56622.26, difference of 0.247 due to clerk summation error of 0.20 and Pickle & Paratha rounding of 0.048)
    expected_pkg_issue = 7249.455
    expected_pkg_bcf = 56622.507
    ...
    expected_sw_issue = 2520.00
    expected_sw_bcf = 6450.00
    ...
    expected_fresh_issue = 5766.50
    expected_fresh_bcf = 4635.00
    ...
    expected_rev = 38280.00
    expected_cogs = 32089.00
    expected_profit = 6191.00
    expected_prep = 986
    expected_sold = 970
    ...
    print("\n=== VERIFICATION SUMMARY FOR 03 JUN 2026 ===")
    if errors:
