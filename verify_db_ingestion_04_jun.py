...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 04 JUN 2026 ===")
    ...
    # Expected values:
    # Dry Issue Total: 13755.504 (Printed register total is 13755.56, difference of 0.056 due to rounding)
    # Dry BCF Total: 212745.201 (Printed register total is 211696.09, difference due to persistent database stock of AMCHUR PDR (10.0 kg @ 105.00 = 1050.00) and minor roundings)
    expected_dry_issue = 13755.504
    expected_dry_bcf = 212745.201
    ...
    # Expected values:
    # Packaging Issue Total: 8769.698 (Printed register total: 8769.60)
    # Packaging BCF Total: 47852.809 (Printed register total: 47852.66, difference of 0.149 due to Pickle & Paratha rounding of 0.148)
    expected_pkg_issue = 8769.698
    expected_pkg_bcf = 47852.809
    ...
    expected_fresh_issue = 2344.00
    expected_fresh_bcf = 2381.00
    ...
    expected_rev = 46385.00
    expected_cogs = 31082.00
    expected_profit = 15303.00
    expected_prep = 1097
    expected_sold = 1083
    ...
    print("\n=== VERIFICATION SUMMARY FOR 04 JUN 2026 ===")
    if errors:
