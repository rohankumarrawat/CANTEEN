...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 02 JUN 2026 ===")
    ...
    # Expected values:
    # Dry Issue Total: 12700.902 (Printed register total is 12700.97, difference 0.068 due to clerk math rounding)
    # Dry BCF Total: 239801.65 (Printed register total is 237702.64, difference due to persistent database stock of AMCHUR PDR (10.0 kg @ 105.00 = 1050.00), BESAN CP valuation discrepancy (5386.50 calculated vs 5186.50 register), and minor roundings)
    expected_dry_issue = 12700.902
    expected_dry_bcf = 239801.65
    ...
    # Expected values:
    # Packaging Issue Total: 9182.95 (Printed register total: 9198.53, difference of 15.58 due to clerk summation error)
    # Packaging BCF Total: 63887.64 (Printed register total: 63871.94, difference of 15.70 due to clerk summation error)
    expected_pkg_issue = 9182.95
    expected_pkg_bcf = 63887.64
    ...
    expected_fresh_issue = 5708.38
    expected_fresh_bcf = 5061.50
    ...
    expected_rev = 46585.00
    expected_cogs = 35967.00
    expected_profit = 10618.00
    expected_prep = 1112
    expected_sold = 1097
    ...
    print("\n=== VERIFICATION SUMMARY FOR 02 JUN 2026 ===")
    if errors:
