...
def run_verifications():
    ...
    print("=== STARTING DATABASE INTEGRITY VERIFICATION FOR 16 MAY 2026 ===")
    ...
    expected_dry_issue = 4104.95
    expected_dry_bcf = 114307.94
    ...
    expected_pkg_issue = 2176.66
    expected_pkg_bcf = 32971.78
    ...
    expected_fresh_issue = 1269.85
    expected_fresh_bcf = 1207.94
    ...
    expected_rev = 10920.00
    expected_cogs = 8363.00
    expected_profit = 2557.00
    expected_prep = 688
    expected_sold = 175
    ...
    print("\n=== VERIFICATION SUMMARY FOR 16 MAY 2026 ===")
    if errors:
